...
* 1) the source image of [CycleGAN]([http://liushuaicheng.org/TIP/SDPGAN/SDPGAN-TIP.pdf](https://github.com/junyanz/pytorch-CycleGAN-and-pix2pix); 
* 2) our own collection from movies or from the Internet. 
